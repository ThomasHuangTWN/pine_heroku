...
def index(request):
	...
	results = Book.objects.filter(name__contains=request.GET.get('query','')) | Book.objects.filter(summary__contains=request.GET.get('query','')) | Book.objects.filter(ISBN__contains=request.GET.get('query','')) | Book.objects.filter(author__contains=request.GET.get('query',''))
